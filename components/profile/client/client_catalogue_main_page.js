...
export default class App extends Component {
    ...
    openFilterMap = async () => {
        ...
        this.setState({
            // location_false_popup: false,
            filter_latitude: location.coords.latitude,
            filter_longitude: location.coords.longitude,
            filter_initialRegion: {
